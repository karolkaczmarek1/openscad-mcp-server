...
-   `list_scad_library_directory` / `read_scad_library_file`: Use these to learn from installed libraries (like BOSL2) if you need complex functions (threads, gears, etc.).
